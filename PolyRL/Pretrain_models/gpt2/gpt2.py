...
def check_transformers():
    ...
    if Version(transformers.__version__) != Version("4.24.0"):
        warnings.warn(
            ...
            f"may not be compatible with the default weights for the GPT-2 model used in PolyRL. "
            f"If you intend to use the default weights provided in PolyRL, please install transformers "
