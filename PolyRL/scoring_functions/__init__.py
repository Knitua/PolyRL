...
from PolyRL.scoring_functions.base import Task
from PolyRL.scoring_functions.chemistry import QED
from PolyRL.scoring_functions.Polyscore.Polyscore import RF_BLR_fing
custom_scoring_functions = {
    "QED": QED,
    "RF_BLR_fing":RF_BLR_fing
}
...
def register_custom_scoring_function(name, scoring_function):
    ...
    Example:
        >>> from PolyRL.scoring_functions import register_custom_scoring_function, custom_scoring_functions
